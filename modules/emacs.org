...
#+begin_src nix :noweb-ref emacs.packages
  home.packages = with pkgs; [
    ...
    <<emacs.update-npm-tools>>
    <<emacs.emenu>>
    <<emacs.doom-git-clone-doom-repo-and-install>>
    <<emacs.doom-git-clone-personal-repo-and-install>>
    <<emacs.dl-restart-emacs-daemon>>
    <<emacs.dl-jumpapp-emacs>>
    <<emacs.org-tangle-tools>>
