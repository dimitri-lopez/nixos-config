...
*** Packages
#+begin_src nix :noweb-ref xfce-home.packages
  # XFCE-specific packages (most are in the system module)
  # home.packages = with pkgs; [
  #   # Add XFCE-specific user packages here
  # ];
#+end_src
