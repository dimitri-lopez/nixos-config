...
buildNpmPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    rev = "v${version}";
    hash = "sha256-1wrvyx5qzs79d0fc1a27qbv1lcch0h16kajhy2khl9igxqbv5ra0";
  };

  npmDepsHash = "sha256-0000000000000000000000000000000000000000000="; # Update after tangle/build
