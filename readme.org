...
** noctalia-shell.nix
:PROPERTIES:
:header-args:nix: :noweb-ref noctalia-shell
:END:

#+begin_src nix :noweb yes :noweb-ref noctalia-shell.nix-setup :tangle ./rices/driftwm-sample/noctalia-shell.nix
{ config, pkgs, lib, ... }:
