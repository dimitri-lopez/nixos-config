...
* DESKTOP SELECTION
:PROPERTIES:
:custom_id: desktop-selection
:END:

Choose your desktop by commenting/uncommenting in BOTH sections below.

*** System imports (configuration.nix)
#+begin_src nix :noweb-ref configuration.nix-imports
imports =
  [ # Include the results of the hardware scan.
    ./hardware-configuration.nix
    
    # === XFCE (uncomment to enable) ===
    # ./modules/xfce/xfce.nix
    
    # === vxwm (no system module needed) ===
    
    # === Hyprland (uncomment to enable) ===
    # ./system/hyprland.nix
