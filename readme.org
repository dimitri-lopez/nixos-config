...
* Inbox
** Boox tablet droidux module
Usage:
1. Enable USB debugging on Boox (Settings → Developer options → USB debugging)
2. Connect Boox via USB
3. Run: ~droidux-connect~ or ~droidux "onyx_emp_Wacom I2C Digitizer"~
